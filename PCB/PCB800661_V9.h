...
#define _SOURCE_1_TYPE            _SOURCE_NONE
...
#define _INPUT_PORT_NUM           1

//Default
#define _NORMAL_SOURCE            _SOURCE_HDMI//_SOURCE_VIDEO_AV//_SOURCE_VGA
...
#define _PIN_113                (1 & 0x07)	// 0 ~ 6 (0: P3D6i, 1: P3D6o<open-drain>, 2: P3D6o<push-pull>, 3: TCON[1], 4: SD2, 5: SPDIF2, 6: IrDA)
...
sbit    bHot_Plug               = P3^7;
#define bHot_Plug2             _NON_CONNECT_PIN
#define bDVICONNECT             _NON_CONNECT_PIN

#define bPanel_LR               (_MCU_PORT75)
#define bPanel_UD               (_MCU_PORT74)
...
#define AUDIO_ON                1
#define AUDIO_OFF               0
sbit    bAUDIO_PWR              = P3^7;   //Pin114

#define _AUDIO_A                (_MCU_PORT81)
sbit    _AUDIO_B                = P3^2;

#define _VOLUME_INV             0
#define _MAX_VOLUME             230   //85
#define _MIN_VOLUME             1   //25

#if(OEM_TYPE == RTD2660_VGA_AV_MP5_DMB)
#define DTV_ON                  1
#define DTV_OFF                 0
#define bDTV_PWR                (_MCU_PORT54)//= P3^7;

#define AML8613_ON              0
#define AML8613_OFF             1
sbit    bAML8613_PWR            = P3^7;
#endif

#ifdef IRSEND_ENABLE
#define  bIRSENDPIN_MP5         (_MCU_PORT57)
#define IR_PIN_H                (bIRSENDPIN_MP5 = 1)
#define IR_PIN_L                (bIRSENDPIN_MP5 = 0)
#endif
